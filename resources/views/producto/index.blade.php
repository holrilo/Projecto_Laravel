                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="float-right">
                                <a class="btn btn-primary" href="{{ url('producto/create') }}">Nuevo</a>
                            </div>
                        </div>
                        <div class="card-body">
                                            ...
                                            <td>
                                                @if (isset($producto->img_producto->descr_img))
                                                    <img class="img-thumbnail img-fluid"
                                                        src="{{ asset('storage' . '/' . $producto->img_producto->descr_img) }}"
                                                        alt="" width="50px" height="50px">
                                                @endif
                                            </td>
                                            <td>
                                                <a class="btn btn-success"
                                                    href="{{ url('/producto/' . $producto->id_producto . '/edit') }}">Editar</a>
                                                |
                                                <form action="{{ url('/producto/' . $producto->id_producto) }}"
                                                    method="post">
                                                    @csrf
                                                    {{ method_field('DELETE') }}
