                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="float-right">
                                <a class="btn btn-primary" href="{{ url('gastosa/create') }}">Nuevo</a>
                            </div>
                        </div>
                        <div class="card-body">
                                ...
                                <tbody>
                                    @foreach ($gastos as $gasto)
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-success" href="{{ url('/gastosa/' . $gasto->id_gasto . '/edit') }}">Editar</a>
                                                <a class="btn btn-success" href="{{ url('/gastosa/' . $gasto->id_gasto . '/pagar/') }}">Pagar</a>
                                                <form action="{{ url('/gastosa/' . $gasto->id_gasto) }}"
                                                    method="post">
                                                    @csrf
                                                    {{ method_field('DELETE') }}
