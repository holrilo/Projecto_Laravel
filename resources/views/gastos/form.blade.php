  ...
  <div class="form-group">
    ...
    <select class="form-control" name="txtIngre" id="txtIngre">
        @if (isset($gastos->id_ingreso))
            <option  selected value=" {{ $gastos->id_ingreso }} ">{{ $gastos->tipo_ingresos->desc_ingreso ." - $ " . $gastos->tipo_ingresos->valor_ingreso }}</option>
            <option >_________________________</option>
...
<a href="{{ url('/gastos')}}" class="btn btn-danger">Regresar</a>
